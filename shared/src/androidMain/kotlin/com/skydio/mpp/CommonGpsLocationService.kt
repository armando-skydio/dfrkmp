...
actual class CommonGPSLocationService  {
    ...
    private fun startGPSLocationUpdates(
        ...
        if(locationCallback == this@CommonGPSLocationService.locationUpdateCallback) return // already using same callback
        this@CommonGPSLocationService.locationUpdateCallback = locationCallback
        this@CommonGPSLocationService.errorCallback = errorCallback
